...
import edu.wpi.first.wpilibj.fulldummy.commands.MoveServo;
import edu.wpi.first.wpilibj.fulldummy.util.TargetReport;
...
public class AxisCam extends Subsystem {
    ...
    public void moveServo(double horizVel, double vertVel){
        double vertPos=posV+(vertVel/100); // Use joystick values to move position
        double horizPos=posH+(horizVel/100);
