...
import edu.wpi.first.wpilibj.fulldummy.commands.AutonomousGroup;
import edu.wpi.first.wpilibj.IterativeRobot;
import edu.wpi.first.wpilibj.command.Command;
import edu.wpi.first.wpilibj.command.Scheduler;
import edu.wpi.first.wpilibj.livewindow.LiveWindow;
import edu.wpi.first.wpilibj.fulldummy.commands.CommandBase;
 ...
 * directory.
 */
public class FullDummyBot extends IterativeRobot {

    Command autonomousCommand;

    public final String teamNo = "  61";
    public final String versionNo = "2014-5-12.00";
